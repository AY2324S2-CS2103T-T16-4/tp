...
with(this){return _c('h3',{attrs:{"id":"appendix-planned-enhancements"}},[_v("Appendix: Planned Enhancements"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#appendix-planned-enhancements","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("1.Validation of lesson dates:\nCurrently, the application validates whether a date and time input have been entered in the specified syntax.\nHowever, no checks are done to check whether an input date has is a real valid date for a future lesson, since\npast dates are allowed to be entered."),_c('br')])}
},function anonymous(
) {
with(this){return _c('p',[_v("4.Recent Commands:\nCurrently, every new command has to be re-entered, which is time-consuming. "),_c('br')])}
},function anonymous(
) {
with(this){return _c('h2',{attrs:{"id":"we"}},[_v("We"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#we","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"appendix-glossary"}},[_v("Appendix: Glossary"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#appendix-glossary","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_v("Mainstream OS: Windows, Linux, Unix, MacOS.")]),_v(" "),_c('li',[_v("Private contact detail: A contact detail that is not meant to be shared with others.")]),_v(" "),_c('li',[_v("Freelance Tutor: A tutor that teaches privately, such as a student that teaches on the side.")]),_v(" "),_c('li',[_v("Fee Status: The status of the payment made/to be made by a student. Can take any alphanumeric value to allow\nflexibility for the tutor.")])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.4.0")]),_v(", generated on Tue, 16 Apr 2024, 0:00:10 GMT+8]")])])])}
}];
